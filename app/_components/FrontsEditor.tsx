...
const FrontsEditor = (props: FrontsEditorProps) => {
  ...
  const handleSaveFrontTypeChanges = () => {
    const updateFrontType = async () => {
      if (frontTypeInputValue.length < 1) { setMessage({message:'A front type must have a name', type: 'error'}); setLoading(false); return }
  ...
  const handleSaveFrontChanges = () => {
    ...
    return (
        ...
        <div>
          ...
          <input type="text" value={frontTypeInputValue} onChange={handleFrontTypeInputValue} className='text-text bg-background rounded py-2 px-4 font-semibold'/>
        </div>
        ...
        {props.front && (
          ...
          {props.front && (
              <p className='text-lg text-text font-semibold'> {props.front.name + ' - ' }
          ...
          <div className='flex flex-col gap-4'>
            <div>
              ...
              <input type="text" value={frontInputValue} onChange={handleFrontInputValue} className='text-text bg-background rounded py-2 px-4 font-semibold'/>
            </div>
