  ...
  return (
    <div className='rounded grow'>
      <Canvas camera={{ position: [5, 5, -25]}} color='#c3c3c3'>
        ...
        <PresentationControls snap global zoom={0.8} rotation={[0, -Math.PI / 8, 0]} polar={[0, Math.PI / 8]} azimuth={[-Math.PI / 6, Math.PI / 6]}>
        <Edges />
        ...
        <Fridge h={21.18} w={6.00} d={5.85} x={-18.2} y={-0.83} />
